REM
REM     Script:        tablespace_non-temp_compare_total_size_with_as.sql
REM     Author:        Quanwen Zhao
REM     Dated:         Nov 05, 2019
REM
REM     Purpose:  
REM       This SQL script usually uses to compare the difference about total size (using WITH ... AS ...) of
...
WITH ddf AS ( SELECT tablespace_name AS ts_name
                     , SUM(bytes)/1024/1024 AS total_mb
              FROM dba_data_files
              GROUP BY tablespace_name
            ),
     ds  AS ( SELECT tablespace_name
     ...
     dt AS ( SELECT ds.tablespace_name AS ts_name
