...
REM         batch grant (only) select privilege on specific user's all of tables to a new user qwz, but this time I
REM         use a relatively simple PL/SQL code snippet to achieve the same intention.
REM
