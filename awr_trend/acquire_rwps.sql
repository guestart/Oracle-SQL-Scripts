...
REM
REM     Purpose:
REM       We can get "RWPS" from the metric_name "Redo Writes Per Sec" of the view "DBA_HIST_SYSMETRIC_SUMMARY".
REM
REM       Next we use the analytic function "LAG () OVER()" to get the prior snap_id from current snap_id for more
REM       clearly showing "Redo Writes Per Sec" between these two snap_id.
REM
REM       SET LINESIZE 80
REM       DESC acquire_rwps
REM        Name                                      Null?    Type
REM        ----------------------------------------- -------- ----------------------------
...
COLUMN rwps        FORMAT 999,999,999.99
