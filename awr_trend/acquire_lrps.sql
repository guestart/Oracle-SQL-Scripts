...
REM
REM     Purpose:
REM       You can find out metric_name "Logical Reads Per Sec" and metric_unit "Reads Per Second" in the view "v$metric".
REM       Typically there saves the average value of "Logical Reads Per Sec" in each of snap_id of the SDDV (Static Data
REM       Dictionary View), "DBA_HIST_SYSMETRIC_SUMMARY", (in which the value of its column "metric_name" is
REM       "Logical Reads Per Sec" and "metric_unit" is "Reads Per Second"), here we use the analytic function "LAG () OVER()"
REM       to get the prior snap_id from current snap_id for more clearly showing "Logical Reads Per Sec" between these two snap_id.
REM
REM       SET LINESIZE 80
REM       DESC acquire_logical_reads_per_sec
REM        Name                                      Null?    Type
REM        ----------------------------------------- -------- ----------------------------
...
REM        METRIC_NAME                               NOT NULL VARCHAR2(22)
