...
REM                    Oct 24, 2021
REM                    Adding the code snippets about "Current OS Load Custom Time Period (interval by each hour)"
REM                    and "Current OS Load Custom Time Period (interval by each day)" for visualizing the oracle performance metric "COL" in the past
...
-- Current OS Load Custom Time Period (interval by each hour).
...
-- Current OS Load Custom Time Period (interval by each day).
