...
REM
REM     Purpose:
REM       You can find out metric_name "User Calls Per Sec" and metric_unit "Calls Per Second" in the view "v$metric".
REM       Typically there saves the average value of "User Calls Per Sec" in each of snap_id of the SDDV (Static Data
REM       Dictionary View), "DBA_HIST_SYSMETRIC_SUMMARY", (in which the value of its column "metric_name" is
REM       "User Calls Per Sec" and "metric_unit" is "Calls Per Second"), here we use the analytic function "LAG () OVER()"
REM       to get the prior snap_id from current snap_id for more clearly showing "User Calls Per Sec" between these two snap_id.
REM
REM       SET LINESIZE 80
REM       DESC acquire_user_calls_per_sec
REM        Name                                      Null?    Type
REM        ----------------------------------------- -------- ----------------------------
