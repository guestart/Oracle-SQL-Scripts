REM
REM     Script:        top10_table_partitions_occupied_by_size.sql
...
REM
REM     Purpose:
REM       Checking the top 10 table partitions that occupied by size (gb) from dba_segments of oracle database.
REM
