REM
REM     Script:        top10_index_partitions_occupied_by_size.sql
...
REM
REM     Purpose:
REM       Checking the top 10 index partitions that occupied by size (gb) from dba_segments of oracle database.
REM
