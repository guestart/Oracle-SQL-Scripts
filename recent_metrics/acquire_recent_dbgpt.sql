REM
REM     Script:        acquire_recent_dbgpt.sql
...
REM
REM     Purpose:
REM       In general we can get metric_name "DB Block Gets Per Txn" and metric_unit "Blocks Per Txn"
REM       from the oracle dynamic performance view "v$sysmetric_history" and "v$sysmetric_summary".
REM
REM       There saves the "DB Block Gets Per Txn" with each interval one minute during the period of recent
REM       one hour in the view "v$sysmetric_history" and there saves the "DB Block Gets Per Txn" with the
