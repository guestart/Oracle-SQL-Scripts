REM
REM     Script:        acquire_recent_prps.sql
...
REM
REM     Purpose:
REM       In general we can get metric_name "Physical Reads Per Sec" and metric_unit "Reads Per Second"
REM       from the oracle dynamic performance view "v$sysmetric_history" and "v$sysmetric_summary".
REM
REM       There saves the "Physical Reads Per Sec" with each interval one minute during the period of recent
REM       one hour in the view "v$sysmetric_history" and there saves the "Physical Reads Per Sec" with the
